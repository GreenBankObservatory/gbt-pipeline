    ...
    for fitsFile in fitsFiles:
        ...
        if refFrame is None:
            ...
            if 'VELREF' in f[0].header:
                ...
                if vref > 255:vref = vref-256

                if vref == 1: refFrame = 'LSR'
                elif vref == 2: refFrame = 'HEL'
                elif vref == 3: refFrame = 'OBS'
        ...
        if refFrame is not None:
            if not 'CTYPE3' in f[0].header or f[0].header['CTYPE3'][0:4] != 'FREQ':
                ...
                if refFrame == "LSR": refCode = 1
                    ...
                    refCode = 3
                    refFrame = "TOP"
                elif refFrame == "LSD": refCode = 4
                elif refFrame == "GEO": refCode = 5
                elif refFrame == "GAL": refCode = 7
                elif refFrame == "LGR" or refFrame == "COB": refCode = -1
        ...
        if arg[0] == "-":
            ...
            if k == "-refframe": 
                if len(v) != 3:
                    ...
                    return
                refFrame = v
            elif k == "-restfreq": restFreq = float(v)
            else:
