...
class ObservationRows:
    ...
    def scans(self):
        ...
        """
        return sorted(list(set([xx.scan for xx in list(self.rows.keys())])))

    def feeds(self):
        """Return a list of feeds in the observation.

        """
        return list(set([xx.feed for xx in list(self.rows.keys())]))

    def windows(self):
        """Return a list of windows in the observation.

        """
        return list(set([xx.window for xx in list(self.rows.keys())]))

    def pols(self):
        """Return a list of polarizations in the observation.

        """
        return list(set([xx.polarization for xx in list(self.rows.keys())]))
