...
if argc < 2:
    ...
    print(
        "usage: doImage mapNH3-50.py <aipsNumber> [<nAverage>] [<mapRaDeg>] [<mapDecDeg>] [<imageXPixels>] [<imageYPixels>]"
    )
    print(
        "where <aipsNumber>     Your *PIPELINE* AIPS number (should always be the same)"
    )
...
restFreqName = "_%.0f" % (restFreqHz * 1.0e-6)
